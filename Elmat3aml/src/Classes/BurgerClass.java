...
import static Classes.ChickenClass.countn;
import static Classes.ChickenClass.totalp;
...
public class BurgerClass implements Menu {
    ...
    public void info(String[] menu, int[] count) {
        // get info from controller to this class 
        this.menu = menu;
        this.count = count;
    }
    ...
    public void Menu() throws ClassNotFoundException, SQLException{
        ...
        for(int i = 0 ; i<menu.length ; i++){
          ...
          String select = "select name,price from burger where name = '" + menu[i]+ "'";
