...
public class ChickenController {
    ...
    ChickenClass myclass= new ChickenClass();
    ...
    void Add1(ActionEvent event) {
        count[0]++;
        menu[0]="Chicken Drums Bucket";
    }

    @FXML
    void Add2(ActionEvent event) {
        count[1]++;
        menu[1]="Pure Chicken Breasts";
    }

    @FXML
    void Add3(ActionEvent event) {
        count[2]++;
        menu[2]="Full Tasty Chicken";
    }
    ...
    void Add6(ActionEvent event) {
        count[5]++;
        menu[5]="Chicken Wings";
    }

    @FXML
    void Add7(ActionEvent event) {
        count[6]++;
        menu[6]="E7naltalata Fried Chicken";
    }

    @FXML
    void Add8(ActionEvent event) {
        count[7]++;
        menu[7]="Juicy Chicken Shawarma";
    }
