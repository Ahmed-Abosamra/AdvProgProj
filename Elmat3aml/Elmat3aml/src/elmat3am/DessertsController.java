...
public class DessertsController {
    ...
    DessertsClass myclass= new DessertsClass();
    ...
    void Add1(ActionEvent event) {
        count[0]++;
        menu[0]="Fruit Pancake";
    }

    @FXML
    void Add2(ActionEvent event) {
        count[1]++;
        menu[1]="Mix Berry Waffle";
    }

    @FXML
    void Add3(ActionEvent event) {
        count[2]++;
        menu[2]="Chocolate Waffle";
    }

    @FXML
    void Add4(ActionEvent event) {
        count[3]++;
        menu[3]="DeliciousCookies";
    }

    @FXML
    void Add5(ActionEvent event) {
        count[4]++;
        menu[4]="Pristine Ice-cream";
    }

    @FXML
    void Add6(ActionEvent event) {
        count[5]++;
        menu[5]="Raspberry Ice-cream";
    }

    @FXML
    void Add7(ActionEvent event) {
        count[6]++;
        menu[6]="ChocoCrispy Ice-cream";
    }

    @FXML
    void Add8(ActionEvent event) {
        count[7]++;
        menu[7]="Raspberry Cake";
    }
